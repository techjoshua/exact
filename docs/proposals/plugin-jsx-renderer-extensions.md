...
Attributed re-export identity tracing, generated trusted catalogs, native compiler emission of
context-effect metadata, and coordinated non-DOM hosts remain. Compilerless package components can
