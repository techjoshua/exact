...
An explicit `documentShell` retains whole-application hydration ownership for a client or
isomorphic application, including paired artifacts that can also publish standalone islands.
