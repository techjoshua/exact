...
[lazy interaction islands](lazy-interaction-islands.md) and
[optional structural render-program refresh extensions](../proposals/compiler-planned-structural-refresh.md).
