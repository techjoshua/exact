...
> Archived after implementation. This record preserves the development plan and its original
...
- [`packages/dom/src/renderer/mounting/root.ts`](../../packages/dom/src/root.ts)
