...
|     8 | [Compiler-owned render programs](proposals/compiler-owned-render-programs.md)                       | **In progress:** initial scalar HTML program, direct SSR, template mount, adoption, and lazy fallback are implemented; broaden eligibility and finish gates. |
|     9 | [Bounded deterministic async SSR](proposals/bounded-deterministic-async-ssr.md)                     | **In progress:** bounded ordered local sibling frames are implemented; finish marker reservation, proof breadth, adapters, and gates.                        |
|    10 | [Compact hydration and progressive publication](proposals/compact-hydration-publication.md)         | **In progress:** grouped finite rows and shared helper are implemented; finish ownership, fallback breadth, adapters, and gates.                             |
...
| [Compiler-owned render programs](proposals/compiler-owned-render-programs.md)                    | Active   | Initial scalar HTML fast path is implemented; finite host semantics and full gates remain.                           |
| [Bounded deterministic async SSR](proposals/bounded-deterministic-async-ssr.md)                  | Active   | Initial markerless local sibling proof and bounded ordered scheduler are implemented.                                |
| [Compact hydration and progressive publication](proposals/compact-hydration-publication.md)      | Active   | Initial grouped table and response-local progressive helper are implemented.                                         |
