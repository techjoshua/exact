...
|     7 | [Dependent performance foundations](proposals/javascript-performance-improvements.md)               | **Completed:** accepted experiments 2–4, implemented experiment 6, rejected unmeasured binary/worker expansion, and recorded evidence.   |
|     8 | [Compiler-owned render programs](proposals/compiler-owned-render-programs.md)                       | Implement shared render slots, direct SSR writing, template mount, compiled adoption, and local generic fallback.                        |
|     9 | [Bounded deterministic async SSR](proposals/bounded-deterministic-async-ssr.md)                     | Implement compiler-proven sibling groups, isolated frames, bounded scheduling, ordered merge, cancellation, and cleanup.                 |
|    10 | [Compact hydration and progressive publication](proposals/compact-hydration-publication.md)         | Implement schema-grouped boundary tables, compiled adoption, row-local fallback, and one response-local progressive helper.              |
|    11 | [Broader lazy interaction-island eligibility](proposals/lazy-interaction-islands.md)                | Implement deferred ownership, replay, capability splitting, hydration, and diagnostics over the settled contracts.                       |
|    12 | [Compiler-planned structural refresh](proposals/compiler-planned-structural-refresh.md)             | Implement typed structural plans using the settled render-slot, activation, and fallback contracts.                                      |
|    13 | [Serializable partial-prerender resumption](proposals/partial-prerender-resumption.md)              | Implement authenticated reconstruction using settled structural plans, SSR ownership, and streaming contracts.                           |
|    14 | [Webpack and Bun microfrontend production parity](proposals/webpack-bun-microfrontend-parity.md)    | Complete heterogeneous adapter conformance over all preceding artifact, trust, locale, activation, refresh, and resumption contracts.    |
|    15 | [Remaining JavaScript performance experiments](proposals/javascript-performance-improvements.md)    | Resolve experiments 5 and 7–13, land or separately propose successful work, rerun whole-framework profiles, and record rejected options. |

The active and gated documents are:

| Proposal                                                                                         | Status   | Scope                                                                                                                |
| ------------------------------------------------------------------------------------------------ | -------- | -------------------------------------------------------------------------------------------------------------------- |
| [JavaScript performance improvements](proposals/javascript-performance-improvements.md)          | Gated    | Retain completed baseline/foundation evidence and complete the remaining measured optimization program.              |
...
| [Compiler-owned render programs](proposals/compiler-owned-render-programs.md)                    | Ready    | Share compiler slot identity across direct SSR, template mounting, hydration adoption, and generic fallback.         |
| [Bounded deterministic async SSR](proposals/bounded-deterministic-async-ssr.md)                  | Ready    | Render only compiler-proven independent siblings concurrently under ordered request-owned scheduling.                |
| [Compact hydration and progressive publication](proposals/compact-hydration-publication.md)      | Ready    | Group finite hydration rows and install one bounded progressive replacement helper per response.                     |
