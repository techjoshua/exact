...
|    11 | [Compiler-planned component execution](proposals/compiler-planned-component-execution.md)           | Emit reusable per-component plans, compose selected roots, and schedule server or client work from explicit reachability and value dependencies.                                                                         |
...
| [Compiler-planned component execution](proposals/compiler-planned-component-execution.md)        | Ready        | Compile reusable component subgraphs and specialize their execution and reactive allocation for SSR and client-only roots. |
