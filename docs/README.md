...
| [Separate enhancements from framework plugins](proposals/enhancements-as-component-composition.md)    | Proposed    | Separate plugins, add activator maps and direct `_` hosts, and bound component-root routing.                                |
