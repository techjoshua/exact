...
|     2 | [Separate enhancements from framework plugins](proposals/enhancements-as-component-composition.md)    | Finish enhancement terminology, activator grouping, `_`, `_target`, bounded routing, and the portable bundler seam.                      |
...
| [Separate enhancements from framework plugins](proposals/enhancements-as-component-composition.md)    | In progress | Terminology, activators, direct `_`, and bounded routing are implemented; `_target`, docs, and package classification remain gated. |
