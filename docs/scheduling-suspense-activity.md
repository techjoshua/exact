...
Pausing a scope after a flush selects its callbacks still parks the remaining computations and
reactions. They retain their queued invalidation until resume or disposal; resuming observes the
