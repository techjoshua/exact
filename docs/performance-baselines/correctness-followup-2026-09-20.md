...
The [structured capture](correctness-followup-2026-09-20.json) links all raw captures and records hashes, source state, exact runners, execution journal, and prior chart values. The [evidence archive](correctness-followup-2026-09-20-evidence.zip) retains the source patch, logs, load plans, and documentation verification. Native samples are in [the native capture](correctness-followup-2026-09-20-native.json).
