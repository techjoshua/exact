...
The [structured capture](bun-admission-final-2026-09-20.json) links raw captures and records hashes, source state, runners, execution journal, and prior chart values. The [evidence archive](bun-admission-final-2026-09-20-evidence.zip) retains source state, logs, plans, and documentation verification. Native samples are in [the native capture](bun-admission-final-2026-09-20-native.json).
