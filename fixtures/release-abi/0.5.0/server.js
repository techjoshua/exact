...
const __exact_render_program_1 = /* @__PURE__ */ __exactPrepareRenderProgram({ version: 1, id: "xuXvkhO9rvfDGXwhd0SlqYa", namespace: "html", ssrRootStatic: [' id="positive"', ["id"], []], ssr: (__exactSsr, __exactContext, __exactInvocation, __exactOutput) => {
...
const __exact_render_program_2 = /* @__PURE__ */ __exactPrepareRenderProgram({ version: 1, id: "xP0SnLqhZnT_BwtC3qgU4V0", namespace: "html", ssrRootStatic: ["", [], [[0, "data-id", "data-id"]], (__exactRootValue) => ({ "data-id": __exactRootValue })], ssr: function __exactRun(__exactSsr, __exactContext, __exactInvocation, __exactOutput, __exactFrame) {
  ...
  switch (__exactStage) {
    case 0:
      __exactSettled = __exactSsr.rootOpening(__exactContext, __exactOutput, __exactValue_0, "li", "<li", ">", __exactCharacters, __exactInvocation.program.ssrRootStatic);
    case 1:
...
const __exact_render_program_3 = /* @__PURE__ */ __exactPrepareRenderProgram({ version: 1, id: "x9JH7IbMlmfXJOl60A8lmJS", namespace: "html", ssrRootStatic: [' data-exact-id="x4N_47mhJKvWOmu7WsIk7c5"', ["data-exact-id"], []], ssr: function __exactRun2(__exactSsr, __exactContext, __exactInvocation, __exactOutput, __exactFrame) {
  ...
  switch (__exactStage) {
    case 0:
      __exactSettled = __exactSsr.rootOpening(__exactContext, __exactOutput, __exactValue_0, "section", "<section", '><button id="increment">', __exactCharacters, __exactInvocation.program.ssrRootStatic);
    case 1:
      __exactCharacters = __exactSettled;
      const __exactDrain_0 = __exactOutput.sink.ready();
      if (__exactDrain_0) {
    ...
    case 2:
      __exactSettled = __exactSsr.text(__exactContext, __exactOutput, __exactValue_1, "0", __exactCharacters, true, "Count ", '</button><button id="reverse">Reverse</button>');
    case 3:
      __exactCharacters = __exactSettled;
      const __exactDrain_1 = __exactOutput.sink.ready();
      if (__exactDrain_1) {
...
const __exactImplementation_Counter_1 = function Counter() {
  ...
  ;
  return __exactPreparedServerRenderProgram(__exact_render_program_3, [{ "data-exact-id": "x4N_47mhJKvWOmu7WsIk7c5" }, this.state.count, this.state.count > 0 && __exactPreparedServerRenderProgram(__exact_render_program_1, [{ id: "positive" }]), this.state.rows.map((row) => __exactKeyedChild(__exactPreparedServerRenderProgram(__exact_render_program_2, [row.id, row.label]), row.id, true))]);
};
