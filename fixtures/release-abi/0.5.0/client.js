// Initial unreleased eXact 0.5.0 ABI fixture. Freeze on publication.
...
const __exact_render_program_1 = /* @__PURE__ */ __exactPrepareRenderProgram({ version: 1, id: "xuXvkhO9rvfDGXwhd0SlqYa", namespace: "html", ssrRootStatic: [' id="positive"', ["id"], []], template: '<strong id="positive">positive</strong>', root: ["strong"], work: [1, 0], directClaims: true, ssr: (__exactSsr, __exactContext, __exactInvocation, __exactOutput) => {
...
const __exact_render_program_2 = /* @__PURE__ */ __exactPrepareRenderProgram({ version: 1, id: "xP0SnLqhZnT_BwtC3qgU4V0", namespace: "html", ssrRootStatic: ["", [], [[0, "data-id", "data-id"]]], template: "<li><!---->\uE000exact:1\uE001<!----></li>", wire: [["li", "html", 1, 2], [[3, 1, 0, true], [7, 0, 0]], [[0, 1], [5, 0, 0]]], directClaims: true, ssr: function __exactRun(__exactSsr, __exactContext, __exactInvocation, __exactOutput, __exactFrame) {
  ...
  switch (__exactStage) {
    case 0:
      __exactSettled = __exactSsr.static(__exactOutput, "<li");
    case 1:
    ...
    case 2:
      __exactSettled = __exactSsr.compiledAttribute(__exactContext, __exactOutput, __exactValue_0, 0, "data-id", "data-id", "li", __exactCharacters);
    case 3:
    ...
    case 4:
      __exactSettled = __exactSsr.text(__exactContext, __exactOutput, __exactValue_1, "0", __exactCharacters, true, ">", "</li>");
    case 5:
      __exactCharacters = __exactSettled;
...
const __exact_render_program_3 = /* @__PURE__ */ __exactPrepareRenderProgram({ version: 1, id: "x9JH7IbMlmfXJOl60A8lmJS", namespace: "html", ssrRootStatic: ["", [], []], template: '<section><button id="increment"><!---->\uE000exact:1\uE001<!----></button><button id="reverse">Reverse</button><!--x:1--><!--/x:1--><ul></ul></section>', wire: [["section", "html", 4, 5], [[0, 1, 0, "button"], [1, 1], [3, 1, 0, true], [2], [5, 3, 1, "1"], [0, 3, 0, "ul"], [1, 3], [4, 4, 0], [2], [7, 0, 1], [6, 2, 17, "button"], [7, 2, 2]], [[11, 1, ["Count ", "", true, 0, 0]], [1, 3], [3, 4], [5, 0, 0], [5, 1, 2], [9, 0, __exact_component_updates_1]]], directClaims: true, keyedChildren: 16, ssr: function __exactRun2(__exactSsr, __exactContext, __exactInvocation, __exactOutput, __exactFrame) {
  ...
  switch (__exactStage) {
    case 0:
      __exactSettled = __exactSsr.static(__exactOutput, '<section><button id="increment"');
    case 1:
      const __exactDrain_0 = __exactOutput.sink.ready();
      if (__exactDrain_0) {
        __exactPending = __exactDrain_0;
    ...
    case 2:
      __exactSettled = __exactSsr.compiledAttribute(__exactContext, __exactOutput, __exactValue_0, 0, "__exactClosedInteraction:onClick", "__exactClosedInteraction:onClick", "button", __exactCharacters);
    case 3:
      __exactCharacters = __exactSettled;
      const __exactDrain_1 = __exactOutput.sink.ready();
      if (__exactDrain_1) {
    ...
    case 4:
      __exactSettled = __exactSsr.text(__exactContext, __exactOutput, __exactValue_1, "0", __exactCharacters, true, ">Count ", '</button><button id="reverse"');
    case 5:
      __exactCharacters = __exactSettled;
      const __exactDrain_2 = __exactOutput.sink.ready();
      if (__exactDrain_2) {
    ...
    case 6:
      __exactSettled = __exactSsr.compiledAttribute(__exactContext, __exactOutput, __exactValue_2, 0, "__exactClosedInteraction:onClick", "__exactClosedInteraction:onClick", "button", __exactCharacters);
    case 7:
      __exactCharacters = __exactSettled;
    ...
    case 8:
      __exactSettled = __exactSsr.static(__exactOutput, ">Reverse</button>");
    case 9:
    ...
    case 12:
      __exactSettled = __exactSsr.static(__exactOutput, "<ul>");
    case 13:
    ...
    case 16:
      __exactSettled = __exactSsr.static(__exactOutput, "</ul></section>");
    case 17:
...
const __exactImplementation_Counter_1 = function Counter() {
  ...
  }), "xElCGagJoEwcOsTr7brw0d_", void 0, "member:id") : void 0, this, (__exactGroup, __exactApply) => {
    if (__exactGroup === 0) {
