...
export function RouteMap(this: Component<{}>, props: {
    ...
    return () => {
        ...
        return (__exactVNode("div", { "data-exact-id": "xtCHfrTpHvMV-JmO_1ZRjGF", className: "map-wrap" }, __exactVNode("svg", { "data-exact-id": "x_LVQ6L9qgtVH6-ndCv5POe", className: "route-map", viewBox: "0 0 800 370", role: "img", "aria-label": __exactExpression(() => start && end
                ? `Approximate route from ${props.origin} to ${props.destination}`
                : 'Approximate United States route map; one or both ZIP codes are unavailable') }, __exactVNode("g", { "data-exact-id": "xg9aQflOSTH-UOsPXPsbv7P", className: "map-states" }, __exactDynamic(() => usStatePaths.map((state) => (__exactVNode("path", { "data-exact-id": "xIKrJYAJcbO5iYcgxjWbcWd", className: __exactExpression(() => `land state state-${state.abbreviation.toLowerCase()}`), d: __exactExpression(() => state.d) }, __exactVNode("title", { "data-exact-id": "x_AosT7DNY25bOPwc_B6Ash" }, __exactDynamic(() => state.name))))))), __exactDynamic(() => arc ? __exactVNode("path", { "data-exact-id": "xzZm9eczoahoRg5ZisTPzEF", className: "route-arc", d: __exactExpression(() => arc) }) : null), __exactDynamic(() => start ? (__exactFragment({}, __exactVNode("circle", { "data-exact-id": "x9S79WVa96qfzc1Dj0foxtT", className: "map-point origin", cx: __exactExpression(() => start.x), cy: __exactExpression(() => start.y), r: "6" }), __exactVNode("circle", { "data-exact-id": "xiNekTMkZJnsWYWBL7vH3sg", className: "map-halo", cx: __exactExpression(() => start.x), cy: __exactExpression(() => start.y), r: "12" }))) : null), __exactDynamic(() => end ? (__exactFragment({}, __exactVNode("circle", { "data-exact-id": "xeDIrDYZ6CdVjt1dRAZKqn0", className: "map-point destination", cx: __exactExpression(() => end.x), cy: __exactExpression(() => end.y), r: "6" }), __exactVNode("circle", { "data-exact-id": "x0PWQiFgaZ2iFPlfNvJZ4oY", className: "map-halo", cx: __exactExpression(() => end.x), cy: __exactExpression(() => end.y), r: "12" }))) : null)), __exactDynamic(() => !start || !end ? (__exactVNode("p", { "data-exact-id": "x1lZMvfXk6FcnBek3T8DSl9", className: "map-unavailable" }, "Map location unavailable for one or both ZIP codes.")) : null)));
    };
}
