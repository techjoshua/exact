import { createCompiledVNode as __exactVNode, createExpression as __exactExpression, writeReactiveLazy as __exactWrite, combineTaskSignal as __exactTaskCombinedSignal, taskAwait as __exactTaskAwait } from "@exactjs/core";
...
import { CalculatorWorkspace } from "./workspace.exact.client.js";
...
export function ShippingCalculatorPage(this: Component<PageState>, props: {
    ...
    this.task(this.reactive(() => this.state.model.configuredProviders), this.reactive(() => this.state.model), async (__exactDependency: ("dhl" | "doop" | "fedex" | "ups" | "usps")[], __exactDependency1: any, { signal }) => {
...
//# sourceMappingURL=page.exact.client.ts.map
