...
export default defineConfig({
	...
	grep: /changes tab content|hold confirmation|preview actions|released orb|physics walls|reactively republishes|renders every temperament|lets Chromium paint/,
