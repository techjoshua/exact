		...
		>
			<section>
				...
				<p>
					...
					shipped version. The defaults explicitly describe the required JSON shape and forbid prose
					or Markdown wrappers. Crossword output is rejected when a clue repeats its answer or
					embeds it in a longer word, with one automatic local repair attempt before the error is
					shown. A response inspector preserves raw initial and repair completions even when parsing
					fails.
				</p>
