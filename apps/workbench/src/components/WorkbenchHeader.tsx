  ...
  return () => (
    <header className="workbench-header">
      <div>
        ...
        <p>{props.visible} of {props.total} tasks visible · {syncLabel(props.syncState)}</p>
      </div>
      ...
      <div className="header-controls">
        ...
        <div className="segmented" role="group" aria-label="View mode">
          <button type="button" className={props.view === "board" ? "active" : ""} onClick={() => workbench.setView("board")}>
            Board
          </button>
          <button type="button" className={props.view === "list" ? "active" : ""} onClick={() => workbench.setView("list")}>
            List
          </button>
        </div>
        ...
        <form className="new-task" onSubmit={event => {
          ...
          <input
            ...
            onInput={event => workbench.setDraftTitle((event.currentTarget as HTMLInputElement).value)}
          />
