...
The adapter only normalizes Node's request/response objects. All eXact protocol validation and server action dispatch remains centralized in `@exact/server`.
