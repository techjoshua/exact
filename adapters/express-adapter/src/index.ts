...
export function createExactExpressMiddleware(context: ExactServerContext): (request: ExactExpressRequest, response: ExactExpressResponse, next?: ExactExpressNext) => void {
