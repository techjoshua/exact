...
- Configure one plugin instance for each build and dispose a directly installed instance when the
  build or watch lifecycle ends. `exactBuild()` performs that cleanup automatically.
