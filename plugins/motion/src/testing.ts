...
/** Creates a testing lifecycle extension for an injected deterministic driver. */
export default function createMotionTestingExtension(
	driver: MotionDriver = createMotionTestDriver()
): ExactRuntimePluginExtension {
	return Object.freeze({
		initializeApplication() {
			return { dispose: installMotionDriver(driver) };
		}
	});
}
