...
if (container.querySelectorAll('li').length !== 1_000)
	throw new Error('1k keyed list lost items during rotation');
if (elapsed > 2_000)
	throw new Error(`1k keyed rotation exceeded 2000ms budget (${elapsed.toFixed(1)}ms)`);
