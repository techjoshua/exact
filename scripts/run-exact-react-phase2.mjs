...
import { collectReactPhase2Trace } from "./react-phase2-scenario.mjs";
...
const result = await collectReactPhase2Trace({ React, ReactDOMClient, JSDOM, baseline: `${target}-exact` });
