...
function isExactStreamStartEvent(
	value: unknown
...
function isExactStreamResultEvent(
	value: unknown
...
function isExactStreamPatchEvent(
	value: unknown
...
function isExactStreamStateEvent(
	value: unknown
...
function isExactStreamHtmlEvent(
	value: unknown
...
function isExactStreamCompleteEvent(
	value: unknown
...
function parseExactOperationResult(
	value: unknown,
	expected?: ExactInvocationRequest,
	limits: ResponseLimits = {}
): ExactOperationResult {
