...
export type ReactNode = ReactElement | ReactPortal | ReactText | boolean | null | undefined | ReactNode[] | object;
export type ReactComponentType<P = Record<string, unknown>> = ((props: P) => ReactNode) | ReactClassType<P> | ReactSpecialType<P>;
...
export interface ReactClassInstance<P = Record<string, unknown>> {
  ...
  render(): ReactNode;
  setState(state: object | null | ((previous: any, props: P) => object | null), callback?: () => void): void;
...
export type ReactRef<T> = ((value: T | null) => void | (() => void)) | MutableRefObject<T | null> | null;
