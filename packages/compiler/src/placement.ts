...
export function combinePlacements(placements: readonly ExactPlacement[]): ExactPlacement {
  ...
  for (const placement of placements) {
    if (placement === "isomorphic") { hasClient = true; hasServer = true; }
...
export function componentPlacementsFromInfo(componentInfo: ReadonlyMap<string, ExactImportedComponentIR>): Map<string, ExactPlacement> {
