...
/** TypeScript 6 compatibility backend retained during the native migration. */
export class LegacyExpressionProject implements ExpressionProjectBackend {
	readonly semanticBackend = 'legacy' as const;
