...
var DismissableLayer = React9.forwardRef(
  (props, forwardedRef) => {
    ...
    const [node2, setNode] = React9.useState(null);
    ...
    const isHighestLayer = node2 ? index === layers.length - 1 : false;
...
function useStableComposedRefs(...refs) {
  ...
  return React23.useCallback((node2) => {
...
var DialogPortal = (props) => {
  ...
  return /* @__PURE__ */ jsx6(PortalProvider, { scope: __scopeDialog, forceMount, children: React21.Children.map(children, (child) => /* @__PURE__ */ jsx6(Presence, { present: forceMount || context.open, children: /* @__PURE__ */ jsx6(Portal, { asChild: true, container, children: child }) })) });
};
...
var ThemeContext = /* @__PURE__ */ React25.createContext({});
var useTheme = function useTheme2() {
  return React25.useContext(ThemeContext);
};
...
var ThemeProvider = function ThemeProvider2(props) {
  var theme = React25.useContext(ThemeContext);
  if (props.theme !== theme) {
    theme = createCacheWithTheme(theme)(props.theme);
  }
  return /* @__PURE__ */ React25.createElement(ThemeContext.Provider, {
    value: theme
  }, props.children);
};
...
var Emotion = /* @__PURE__ */ withEmotionCache(function(props, cache, ref) {
  ...
  var serialized = serializeStyles(registeredStyles, void 0, React25.useContext(ThemeContext));
...
var useQueryClient = (queryClient) => {
  const client = React27.useContext(QueryClientContext);
  if (queryClient) {
    return queryClient;
  }
  if (!client) {
...
var QueryClientProvider = ({
  ...
  return /* @__PURE__ */ jsx9(QueryClientContext.Provider, { value: client, children });
};
...
var QueryErrorResetBoundaryContext = React29.createContext(createValue());
...
function useBaseQuery(options, Observer, queryClient) {
  ...
  const [observer] = React31.useState(
    () => new Observer(
      client,
      defaultedOptions
    )
