...
export function createExactServerlessHandler(context: ExactServerContext): (event: ExactServerlessEvent) => Promise<ExactServerlessResult> {
  return async event => {
...
export async function responseToServerlessResult(result: ExactResponseLike): Promise<ExactServerlessResult> {
  return {
