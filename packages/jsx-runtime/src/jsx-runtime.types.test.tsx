...
import type { JSX } from '@exactjs/jsx/jsx-runtime';
import { _ } from '@exactjs/jsx/jsx-runtime';
...
describe('@exactjs/jsx types', () => {
	it('type-checks the native TSX surface without executing a runtime fallback', () => {
		expect(typecheckNativeJsx).toBeTypeOf('function');
	});
});
