...
export const QueryClientContext = createContext<QueryClient>("exact.tanstack-query.client", { reactive: false });
...
>(
  ...
  return createObserverSource(new QueryObserver(client, options)) as ExactQuerySource<TData, TError>;
}
...
): ExactObserverSource<InfiniteQueryObserverResult<any, any>, InfiniteQueryObserverOptions<any, any, any, any, any>, InfiniteQueryObserver<any, any, any, any, any>> {
...
): ExactObserverSource<MutationObserverResult<any, any, any, any>, MutationObserverOptions<any, any, any, any>, MutationObserver<any, any, any, any>> {
  return createObserverSource(new MutationObserver(client, options));
}

function createObserverSource<TResult, TOptions, TObserver extends {
  ...
  return Object.freeze({
    ...
    external,
    setOptions(next: TOptions) { observer.setOptions(next); external.refresh(); },
